...
**Laatst bijgewerkt:** 14 jun 2026 (Sessie 165)
...
**Sprint:** Sessie 165 — Kwaliteits-/feitencontrole betaalde Gumroad-producten (`docs/products/`). Claim-inventaris (3 Explore-agents) + eigen WebSearch/WebFetch-bronverificatie. Kernuitkomst: producten feitelijk sterk; verreweg de meeste 'verdachte' punten VALS ALARM (OWASP Top 10:2025-volgorde playbook+leerplan correct, art. 138ab-strafmaten + '20 april 2016'-ingangsdatum correct, boete 4e cat €27.500, OSCP $1.749, eJPT→INE, TryHackMe 54/13, Gelderland-zaak, alle sim-commando's bestaan). 3 ECHTE issues gefixt: (1) listings-pagina-aantallen overdreven (~15/~35/~25/~75 → echte 13/19/15/47 via `pdfinfo`; playbook 84% overdreven) — natelbaar=betrapbaar; (2) Juridische Gids Krol-zaak feitfout ('gemeenteraadslid'→'journalist en politicus', 'geanonimiseerde'→'echte') + geverifieerde ECLI-bronnen (RBOBR:2013:BZ1157 + Gelderland-news-URL), zaak 2 (2014, onverifieerbaar) genericeerd; (3) listings MailerLite→Brevo. Helderheids-pass playbook+leerplan: glosses CVE/CVSS/ICMP + OWASP-2025-namen exact (A08/A09/A10) + SQLi-superlatief genuanceerd. Fixes in `.typ`-bron, 3 PDF's herbouwd (typst 0.13.1 lokaal, geen warnings), output geverifieerd (paginatelling + pdftotext). **Handmatig voor Heisenberg:** herbouwde PDF's + listing-teksten opnieuw naar Gumroad uploaden (buiten repo). **Deferred:** current.md bulk-rotatie 155-159 — archief-bestemmingsconventie dubbelzinnig, niet geriskeerd vóór commit. **Pre-Sessie 165:** zie `docs/sessions/current.md`.
