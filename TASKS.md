...
- [ ] **Launch-uitvoering — doel wo 29 juli 2026 (handmatig, demand-validatie #44 bewust overgeslagen):** D-1 (di 28 jul avond) GSC sitemap-resubmit + indexering aanvragen homepage/`/blog/`/metasploit-post + Bing import + GA4 DebugView-funneltest + link-check copy; launch-dag GA4-annotatie + posten per `docs/launch-announcement-kit.md` §5 (blok 13:00–18:00 CET, EHGN→Reddit→Show HN→LinkedIn→X). D+14 `site:` + GSC Coverage her-meten.
