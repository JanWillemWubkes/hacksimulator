...
**Current Status:** ✅ LIVE — Playwright E2E: **232 tests, 27 spec files** (Chromium, Firefox, WebKit) | AdSense + Ko-fi + Brevo (deliverability getuned) + Gumroad v1.0 + Lead magnet live
...
- **Playwright:** 27 spec files, 232 tests per browser-project (`npx playwright test --list --project=chromium`, geverifieerd Sessie 194; Sessie 193 added `deeplink-coherentie`-tests, Sessie 194 added `vfs-versioning.spec.js` 3 tests)

<!-- VALIDATE-BUNDLE-START Sessie 157 — ground-truth target voor scripts/validate-docs.sh --deep -->
<!-- src=666 styles=394 blog=414 assets=1030 (KB unminified, du -sb / 1024 basis; Sessie 194 ground-truth meting — src +19KB vs Sessie 192: Sessie 193 scenario-setup.js + 18 fixes, Sessie 194 vfs-signature + notice) -->
<!-- VALIDATE-BUNDLE-END -->
