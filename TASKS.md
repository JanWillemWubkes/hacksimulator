...
**Current Status:** ✅ LIVE — Playwright E2E: **236 tests, 27 spec files** (Chromium, Firefox, WebKit) | AdSense + Ko-fi + Brevo (deliverability getuned) + Gumroad v1.0 + Lead magnet live
...
- **Playwright:** 27 spec files, 236 tests per browser-project (`npx playwright test --list --project=chromium`, geverifieerd Sessie 195; Sessie 195 added +4 tests in bestaande specs: leerpad whois/traceroute-dekking + EXPERT-unlock (fundamentals) + traceroute-tracking-guard + hint-`*`-marker (command-coverage))

<!-- VALIDATE-BUNDLE-START Sessie 157 — ground-truth target voor scripts/validate-docs.sh --deep -->
<!-- src=670 styles=394 blog=415 assets=1031 (KB unminified, du -sb / 1024 basis; Sessie 195 ground-truth meting — src +4KB vs Sessie 194: learning-path.js single-source-module; blog +1KB claim-fixes) -->
<!-- VALIDATE-BUNDLE-END -->
