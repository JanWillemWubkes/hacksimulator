...
49. [x] **GEO/AEO — vindbaarheid in AI-zoekmachines (Sessie 203, commit `202c8eb`, gepusht + live)** — llms.txt + robots.txt AI-stanzas + FAQPage op index + DefinedTermSet 5→56 met lockstep-check + WebApplication op terminal + HowTo op wireshark/metasploit + §5 GEO in seo-launch-checklist.md. **Open (Heisenberg, zie checklist §5):** Bing Webmaster, herindexering GSC/Bing (4 pagina's), externe vermeldingen, ~1 mnd controle of AI-engines HackSimulator citeren.
