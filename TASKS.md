...
**Laatst bijgewerkt:** 30 jun 2026 (Sessie 187)
...
**Current Status:** ✅ LIVE — Playwright E2E: **207 tests, 24 spec files** (Chromium, Firefox, WebKit) | AdSense + Ko-fi + Brevo (deliverability getuned) + Gumroad v1.0 + Lead magnet live
...
- **Playwright:** 24 spec files, 207 tests per browser-project (`npx playwright test --list --project=chromium`, geverifieerd Sessie 187; Sessie 187 added `fundamentals.spec.js`)

<!-- VALIDATE-BUNDLE-START Sessie 157 — ground-truth target voor scripts/validate-docs.sh --deep -->
<!-- src=631 styles=394 blog=414 assets=1030 (KB unminified, du -sb / 1024 basis; Sessie 185 ground-truth meting — styles +2KB landing.css leerpad-CTA-groep) -->
<!-- VALIDATE-BUNDLE-END -->
...
4. ✅ Cross-browser test infrastructure (Playwright 207 tests, 24 spec files)
