...
**Laatst bijgewerkt:** 2 jun 2026 (Sessie 147)
**Status:** M7 Gamification ✅ 100% | M6 Tutorial System 88% | M5.5 Monetization ✅ Live + Brevo deliverability tuned + Gumroad v1.0 + Lead magnet (LIVE on hacksimulator.nl) | Doc-protocol refactor + forcing function (Sessie 140) | Terminal Core ⚠️ ~547 KB minified + ✅ **Lighthouse terminal Mobile 49→59 / Desktop 77→94** ná Pad C1+C2 (Sessie 144, sample-pentest mobile 73→82 / desktop 99→100) + Sessie 147 baseline mediaan mobile 74 / FCP 1277 ms / LCP 4116 ms (run-variance lager dan Sessie 145/146)
**Sprint:** Sessie 147: Item #29 ✅ gesloten via Frame C (resource-priority-regressie bewezen). Verify-first-plan (eigen plan-file met 6-signaal decisional-thresholds-tabel + symmetrische 33,3%-clustering) uitgevoerd: 3-run mediaan Lighthouse@11 mobile baseline vóór + ná modulepreload-patch op terminal.html `<head>` (navbar.js + footer.js, `fetchpriority=auto`, legal.js EXCLUDED want transitief via main.js graph). Multi-metric delta: S6/S7 resource-fetchStart -240/-236 ms ✅ Frame A (mechanisme werkt) MAAR S1 LCP +133 / S2 TBT +335 / S3 Layout +167 / S4 LT1 +210 ms allemaal ⚠️ Frame C. Score mediaan 74→62 (-12 punten). Mechanisme: modulepreload-fetchpriority=auto concurreert met CSS-high tijdens initial-connection-phase → CSS-fetch verlaat → FCP/LCP/Layout/long-task cascade-regressie. Revert commit `6c2ac7a` live in 21 sec. **3e sessie op rij waarin mobile-delta-verwachting door data gefalsifieerd** (Sessie 145 box-utils Frame B + Sessie 146 #28 Frame D + Sessie 147 #29 Frame C) — structureel patroon, anti-rationalisatie-discipline volwassen. Spawn #30 (sync-inline navbar/footer) + #31 (terminal.html:43 src/main.js version-param-mismatch, main.js gefetched 2x). Audit-doc §2c + plan-file `/home/willem/.claude/plans/heisenberg-hier-pak-item-foamy-sprout.md`.
...
31. [ ] **terminal.html:43 modulepreload version-param-mismatch fix** (Sessie 147 spawn — out-of-scope observatie tijdens #29) — `<link rel="modulepreload" href="src/main.js">` (regel 43, geen `?v=`) mismatcht `<script src="src/main.js?v=88-multiline-wrap">` (regel 385, met `?v=`). Browser-dedupe faalt door URL-mismatch → main.js gefetched **2x** in productie (bewezen via LH@11 network-requests audit Sessie 147 Phase 1: zowel `main.js` 2428 bytes als `main.js?v=88-multiline-wrap` 3107 bytes apart geladen, ~5,5 KB waste per page-load). **Fix opties:** (a) strip `?v=88-multiline-wrap` van regel 385 — verlies cache-busting bij next bundle-update; (b) sync `?v=88-multiline-wrap` naar regel 43 modulepreload — moet bij elke versie-bump op twee plekken. Optie (b) sluit aan bij bestaande `?v=114` pattern op CSS regels 41-42. **Scope:** ~10 min + 1 LH-run om dedupe te bevestigen (verwacht: ~5 KB transfer-reductie). Geen Frame-bepaling nodig, simpele bug-fix met deterministische verification.
...
**Laatst bijgewerkt:** 2 jun 2026 (Sessie 147)
**Versie:** 5.1 (Sessie 147 — Item #29 ✅ gesloten via Frame C (resource-priority-regressie). Verify-first-plan uit `/home/willem/.claude/plans/heisenberg-hier-pak-item-foamy-sprout.md` uitgevoerd: 6-signaal decisional-thresholds-tabel met symmetrische 33,3%-clustering (anti-Sessie-146-redundancy 37%-grens), Phase 1 ontdekte 3 correcties (legal.js EXCLUDED transitief via main.js graph, leading-slash path-style, terminal.html:43 version-param-mismatch out-of-scope #31). 3-run mediaan LH@11 mobile vóór: score 74 / LCP 4116 / TBT 477 / Top-1 Layout 166,5 / Top-1 RunTask 208,1 / navbar+footer rendererStart 441 ms. Patch (3 HTML-regels ~240 bytes, `fetchpriority="auto"`, commit `baa4cf3`, deploy 11s). Post-patch mediaan: score 62 / LCP 4250 / TBT 813 / Top-1 Layout 334 / Top-1 RunTask 418 / navbar+footer rendererStart 200/205. **Multi-metric delta:** S6/S7 resource-fetchStart -240/-236 ms ✅ Frame A (modulepreload werkt zoals technisch verwacht) MAAR S1 LCP +133 / S2 TBT +335 / S3 Layout +167 / S4 LT1 +210 ms allemaal ⚠️ Frame C (page-perf-regressie). 4/4 page-perf-signalen Frame C-threshold. Mechanisme: modulepreload-fetchpriority=auto concurreert met CSS-high tijdens initial-connection-phase → CSS-fetch verlaat → cascade-regressie. Revert commit `6c2ac7a` + deploy 21s. **3e sessie op rij waarin mobile-delta-verwachting structureel-gefalsifieerd** (Sessie 145 box-utils Frame B + Sessie 146 #28 Frame D + Sessie 147 #29 Frame C) — patroon nu structureel verankerd. Spawn #30 sync-inline navbar/footer + #31 main.js version-param-mismatch. Defense-in-depth alle 4 plekken (audit-doc §2c + TASKS.md item #29 + CLAUDE.md learnings + current.md Sessie 147).)
