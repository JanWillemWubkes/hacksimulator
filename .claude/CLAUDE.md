...
**Status:** MVP Development — ✅ LIVE on Netlify (laatste: Sessie 151)
...
**Rotation:** Keep last 6 full (146-151). Archive: docs/sessions/ (current.md, recent.md, archive-*.md)
Pre-Sessie 146 learnings (incl. Sessie 126 Brevo-migratie + 127 Typst PDF + 128 Gumroad factcheck/taalconsistentie + 129-133 monetization-stack + 134 Brevo DnD-herbouw + 135 DNS cleanup + 136 Postmaster re-check + 137 funnel-pulse + 138 OWASP hub-post + 139 unified marketing nav + 140 Doc-Protocol Refactor + 141 Terminal Core Runtime-Verificatie + 142 Lighthouse Meet-Frame-Bias + 143 Third-Party Audit + 144 Pad C1+C2 Implementatie + 145 Item #26 Frame B Lighthouse-Attributie-Bias) → zie `docs/sessions/current.md`. Sessie 138 was 1-in-1-out Sessie 144; sessies 135/136/137/139 archived in bulk Sessie 145; Sessie 140 was 1-in-1-out Sessie 146; Sessie 141 was 1-in-1-out Sessie 147; Sessie 142 was 1-in-1-out Sessie 148; Sessie 143 was 1-in-1-out Sessie 149; Sessie 144 was 1-in-1-out Sessie 150; **Sessie 145 was 1-in-1-out Sessie 151 → current.md**. Volgende bulk-rotation trigger Sessie 155 (verwijdert 146-150 zodra 155 toegevoegd).
