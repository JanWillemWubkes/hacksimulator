  ...
  <footer class="landing-footer" role="contentinfo">
    ...
    <div class="footer-bottom">
      ...
      <div class="footer-social">
        ${showDonate ? `<a href="https://ko-fi.com/hacksimulator" class="footer-donate" aria-label="Steun HackSimulator via Ko-fi" title="Steun ons met een koffie" rel="noopener noreferrer" target="_blank">[♥] Steun ons</a>` : ''}
