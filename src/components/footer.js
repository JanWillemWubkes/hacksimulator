  ...
  <footer class="landing-footer" role="contentinfo">
    ...
    <div class="footer-bottom">
      ...
      <div class="footer-social">
        ${showDonate ? `<a href="https://paypal.me/HackSimulator" class="footer-donate" aria-label="Doneer via PayPal om onze educatieve missie te steunen" title="Steun onze educatieve missie" rel="noopener noreferrer" target="_blank">[+] Doneer</a>` : ''}
