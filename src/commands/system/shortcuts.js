...
function buildMobileOutput() {
  ...
  out += '[TIP] Deze shortcuts werken net als in echte Linux terminals\n';
  out += '[?] Op mobiel: gebruik Tab om aan te vullen\n';
  return out;
}
