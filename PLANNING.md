...
**Laatst bijgewerkt:** 09 aug 2026 (Sessie 216 — GEEN architectuur-wijziging: de mobiele CTA-balk kreeg een zichtbaarheidsregel binnen de bestaande static-site-architectuur; geen nieuwe afhankelijkheid, geen build-stap, IntersectionObserver in het al bestaande `landing-demo.js`)
