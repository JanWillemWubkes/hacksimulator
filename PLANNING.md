...
**Laatst bijgewerkt:** 5 sep 2026 (Sessie 233 — **design-system-wijziging:** de self-hosted font-subset is niet alleen een performance-keuze maar een dekkingsbelofte. Miste hij een glyph die de UI gebruikt, dan viel die terug op een systeemfont en werd het verschil met CSS weggepoetst — waarmee de correctie zelf een bug werd. De subset dekt nu élk teken dat de terminal tekent; glyph-correcties in CSS zijn daarmee verboden i.p.v. gebruikelijk)
