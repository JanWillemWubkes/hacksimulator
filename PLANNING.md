...
**Laatst bijgewerkt:** 21 aug 2026 (Sessie 230 — **geen architectuurwijziging, wél een layout-invariant die eerder nergens stond:** in een grid met één impliciete `auto`-track bepaalt het breedste item de breedte van álle items, dus één vaste inputbreedte in het nieuwsbriefblok maakte alle 15 blogkaarten 400px breed in een container van 336px — onzichtbaar weggeknipt door `overflow-x: hidden`. Vastgelegd in `css-layout.md` §22.)
