...
**Laatst bijgewerkt:** 15 sep 2026 (Sessie 234 — geen architectuurwijziging, wél een infrastructuurwissel buiten de applicatie: `contact@hacksimulator.nl` verhuisde van TransIP naar Zoho Mail op het EU-datacenter in Nederland. Stack, hosting en build blijven ongemoeid; de wissel raakt DNS en de verwerkerstabel in `privacy.html`, niet de architectuur.)
