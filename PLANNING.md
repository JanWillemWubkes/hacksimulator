...
**Laatst bijgewerkt:** 2 jun 2026 (Sessie 147 — /summary doc-sync only, geen architectuur-wijziging. Item #29 ✅ gesloten via Frame C (resource-priority-regressie). Modulepreload-patch S6/S7 navbar/footer fetchStart -240 ms ✅ Frame A MAAR S1/S2/S3/S4 page-perf alle Frame C door modulepreload-vs-CSS-priority-conflict. Revert + spawn #30 sync-inline navbar/footer + #31 main.js version-param-mismatch. 3e sessie op rij waarin mobile-delta-verwachting structureel-gefalsifieerd. Defense-in-depth 4 plekken. Vorige inhoudelijke wijziging Sessie 144 — Pad C1+C2 implementatie voltooid: adsbygoogle.js verwijderd van 6 no-slot pages + animations.css critical-split + fetchpriority hints. Productie-Lighthouse terminal.html mobile 49→59 / desktop 77→94, sample-pentest desktop 99→100.)
...
**Versie:** 3.7 (Sessie 147 doc-sync, geen architectuur-wijziging. Item #29 ✅ gesloten via Frame C — modulepreload-patch werkt mechanisch (S6/S7 -240 ms = Frame A) MAAR S1 LCP +133 / S2 TBT +335 / S3 Layout +167 / S4 LT1 +210 ms allemaal Frame C-regressie door modulepreload-vs-CSS-priority-conflict tijdens initial-connection-phase. Score mediaan 74→62. Revert commit `6c2ac7a`. **3e sessie op rij waarin mobile-delta-verwachting structureel-gefalsifieerd** (Sessie 145 box-utils Frame B + Sessie 146 #28 Frame D + Sessie 147 #29 Frame C). Spawn #30 sync-inline + #31 main.js version-param-mismatch. Bundle Size Budget sectie ⚠️-status ongewijzigd. Defense-in-depth 4 plekken. Vorige inhoudelijke wijziging Sessie 144 — Pad C1+C2 implementatie voltooid: HTML-head edits op 7 pages + audit-doc §7. Productie-Lighthouse delta terminal mobile 49→59 (+10) / desktop 77→94 (+17), sample-pentest mobile 73→82 (+9) / desktop 99→100 (+1).)
